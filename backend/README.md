...
## Project Structure
    ...
    ├── testdeployment_dev_33417  # Django project configurations
...
1. Clone this repo and `cd testdeployment_dev_33417`
...
2. Clone this repo and `cd testdeployment_dev_33417`
